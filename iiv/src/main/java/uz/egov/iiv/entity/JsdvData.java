...
@Entity
@Table(name = "jsdv_data")
public class JsdvData extends JshshirEntity implements Serializable {

    //Доимий яшаш жойи бўйича маълумотлар
    @JsonProperty("drdata")
    @JsonFormat(pattern = "dd.MM.yyyy", timezone = "Asia/Tashkent")
    protected Date DRData;//Рўйхатга олинган сана	Date		[1]
    @JsonProperty("dydav")
    @Column(length = 3)
    protected String DYDav;//Мамлакат	String	3 та белги, маълумотнома асосида	[1]
    @JsonProperty("dyvil")
    @Column(length = 2)
    ...
    @Column(length = 255)
    protected String DYKucha;//Кўча номи	String	255 тагача белги	[1]
    @JsonProperty("dyuyn")
    @Column(length = 255)
    protected String DYUyN;//уй рақами	String	255 тагача белги	[1]
    @JsonProperty("dyxonan")
    @Column(length = 255)
    protected String DYxonaN;//хонадон рақами	String	255 тагача белги	[1]
    @JsonProperty("dykadastrn")
    @Column(length = 255)
    protected String DYKadastrN;//объектнинг кадастр рақами	String	255 тагача белги	[1]
    ...
    @ToString.Exclude
    @JsonIgnore
    private JsdvInfo information;

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || Hibernate.getClass(this) != Hibernate.getClass(o)) return false;
        JsdvData that = (JsdvData) o;
